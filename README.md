# IARC bioinformatics nextflow pipelines (updated on 15/06/2021)
...
| [strelka2-nf](https://github.com/IARCbioinfo/strelka2-nf)   |v1.2a - Dec 2020|🟢 Yes| Runs Strelka 2 (germline and somatic variant caller)|[Strelka2](https://github.com/Illumina/strelka)|
...
| [table_annovar-nf](https://github.com/IARCbioinfo/table_annovar-nf) |v1.1.1 - Feb 2021|🟢 Yes| Annotate variants with annovar (vcf files) |[annovar](http://annovar.openbioinformatics.org/en/latest/)|
|****************** |*********** |*********** |************************* |************************ |
...
|****************** |*********** |*********** |************************* |************************ |
| [purple-nf](https://github.com/IARCbioinfo/purple-nf)   |v1.0 - May 2021|🟢 Yes|🔴 NEW pipeline: Performs copy number calling from tumor/normal or tumor-only sequencing data using PURPLE |[PURPLE](https://github.com/hartwigmedical/hmftools/tree/master/purple)|
...
| [nf-hla-neo](https://github.com/IARCbioinfo/nf-hla-neo)   |v1.1 - June 2021|🟢 Yes|🔴 NEW pipeline: predict neoantigens from WGS of T/N pairs |[xHLA](https://github.com/humanlongevity/HLA), [VEP](https://github.com/Ensembl/ensembl-vep), [pVACtools](https://github.com/griffithlab/pVACtools)|
...
| [methylkey](https://github.com/IARCbioinfo/methylkey)   | May 2021 |🟢 Yes|Pipeline for 450k and 850k array analysis (bisulfite data analysis using Minfi, Methylumi, Comet, Bumphunter and DMRcate packages)|[R software](https://www.r-project.org/)|
| [AmpliconArchitect](https://github.com/IARCbioinfo/AmpliconArchitect)   | April 2021 |🟢 Yes|Forked from virajbdeshpande/AmpliconArchitect |[AmpliconArchitect](https://github.com/virajbdeshpande/AmpliconArchitect)|
